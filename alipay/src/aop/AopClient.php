...
class AopClient
{
    ...
    /**
     * 生成用于调用收银台SDK的字符串
     * @param $request AlipayBaseRequestInterface SDK接口的请求参数对象
     * @return string
     * @author guofa.tgf
     */
    ...
    */
    ...
    public function pageExecute($request, $httpmethod = "POST")
    {
        ...
        if (method_exists($request, "getNeedEncrypt") && $request->getNeedEncrypt()) {
            ...
            // 执行加密
            $enCryptContent = AopEncryptUtils::encrypt($apiParams['biz_content'], $this->encryptKey);
    ...
    private function encryptJSONSignSource($request, $responseContent)
    {
        ...
        $bizContent = AopEncryptUtils::decrypt($parsetItem->encryptContent, $this->encryptKey);
