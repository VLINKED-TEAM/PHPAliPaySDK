...
use VlinkedAliPay\service\AlipayTradeService;
use VlinkedAliPay\payload\builder\AlipayTradeFastpayRefundQueryContentBuilder;
...
if (!empty($_POST['WIDout_trade_no']) || !empty($_POST['WIDtrade_no']) && !empty($_POST['WIDout_request_no'])) {
    ...
    try {
        $Response = new AlipayTradeService(new MyConfig());
